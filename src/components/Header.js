...
export default function Header() {
  const [searchHidden, setSearchHidden] = React.useState(true);
  ...
  return (
    <header>
      <nav className="bg-white border-b-2  border-gray-200 py-3 dark:bg-gray-900 dark:border-b-1 dark:border-gray-100 ml-auto">
        <div className=" flex flex-wrap items-center justify-between mx-auto p-4">
      <NavLink to="" className="flex items-center">
          <img src={mylogo} className="h-8 mr-2 rounded-xl" alt="My-Logo" />
          ...
          <div id="mobile-nav" className="flex md:order-2">
            <button
              ...
              data-tooltip-target="audio-bottom-nav-example-toggle-dark-mode-tooltip"
              type="button"
              data-toggle-dark="dark"
              className="flex items-center w-9 h-9 ml-1 mr-2 justify-center text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
            >
              {darkMode ? (
                <>
                  <svg
                ...
                <>
                  <svg
                    ...
                    viewBox="0 0 20 20"
                  >
                    <path d="M10 15a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0-11a1 1 0 0 0 1-1V1a1 1 0 0 0-2 0v2a1 1 0 0 0 1 1Zm0 12a1 1 0 0 0-1 1v2a1 1 0 1 0 2 0v-2a1 1 0 0 0-1-1ZM4.343 5.757a1 1 0 0 0 1.414-1.414L4.343 2.929a1 1 0 0 0-1.414 1.414l1.414 1.414Zm11.314 8.486a1 1 0 0 0-1.414 1.414l1.414 1.414a1 1 0 0 0 1.414-1.414l-1.414-1.414ZM4 10a1 1 0 0 0-1-1H1a1 1 0 0 0 0 2h2a1 1 0 0 0 1-1Zm15-1h2a1 1 0 0 0 0-2h-2a1 1 0 0 0 0 2ZM4.343 14.243l-1.414 1.414a1 1 0 1 0 1.414 1.414l1.414-1.414a1 1 0 0 0-1.414-1.414ZM14.95 6.05a1 1 0 0 0 .707-.293l1.414-1.414a1 1 0 1 0-1.414-1.414l-1.414 1.414a1 1 0 0 0 .707 1.707Z"></path>
                  </svg>
